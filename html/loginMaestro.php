...
session_start();
if(@$_SESSION['user2']){
    header("Location:../Html/resultados.php");
}
?>
...
<img  id="estudiante" src="../images/maestro.png"></img>
